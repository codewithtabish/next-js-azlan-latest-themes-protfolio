...
import faqContent from '@/constants/(translate)/faq-content';
...
export default function FaqComp({ lang = "en" }: Faq3Props) {
    ...
    <section className="relative w-full  bg-background ">
      ...
      <div className="container relative mx-auto max-w-6xl px-2 sm:px-4">
        ...
        >
          ...
          <h1 className="mb-3 bg-gradient-to-r from-primary p-4 to-rose-400 bg-clip-text text-2xl sm:text-3xl md:text-4xl font-bold text-transparent">
            {headerTitle}
          </h1>
