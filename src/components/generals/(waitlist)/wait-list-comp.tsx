...
import waitlistContent from '@/constants/(translate)/waitlist-content';
import { Spotlight } from '@/components/(mvpblocks)/spot-light';
import { Particles } from './particels';
import { WaitListPageTabs } from './waitlist-page-tabs';
import TocDialog from './toc-dialouge';
  ...
  return (
    <div className='w-full '>
      <main className="relative items-center justify-center ">
        ...
        <div className="relative z-[100] mx-auto w-full  px-2 sm:px-6 py-10 text-center">
          {/* Badge */}
          <motion.div
          ...
          <motion.h1
            ...
            className={cn(
              'mb-4 cursor-crosshair bg-gradient-to-b from-foreground via-foreground/80 to-foreground/40 bg-clip-text text-3xl sm:text-3xl lg:text-5xl font-bold text-transparent',
              brico.className,
          ...
          <motion.p
            ...
            className={cn(
              "mb-12 mt-2 text-muted-foreground text-base sm:text-lg line-clamp-2 text-center  mx-auto md:max-w-[70%]",
              isRtl ? "text-right" : "text-center"
            )}
            dir={isRtl ? 'rtl' : 'ltr'}
          >
