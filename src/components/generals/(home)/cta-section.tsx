...
import { callToActionContentArray } from "@/constants/(translate)/cta-content"
...
export default function CallToActionSection({ locale = "en" }: Props) {
  const section =
    callToActionContentArray.find((s) => s.code === locale) ||
    callToActionContentArray.find((s) => s.code === "en")!
