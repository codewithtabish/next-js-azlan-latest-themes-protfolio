...
import { companiesSectionTitlesArray } from "@/constants/(translate)/companies-trusted"
...
export default function HomeLogoCloud({ locale = "en" }: HomeLogoCloudProps) {
  ...
  const section =
    companiesSectionTitlesArray.find((s) => s.code === locale) ||
    companiesSectionTitlesArray.find((s) => s.code === "en")!
